  ...
  return (
    <div style={{ maxWidth: '1200px', margin: isMobile ? '10px auto' : '40px auto', padding: isMobile ? '0 15px' : '0 20px', position: 'relative' }}>
      ...
      <div style={{ padding: isMobile ? '10px 0 20px 0' : '40px 20px', textAlign: isMobile ? 'left' : 'center' }}>
        ...
        {/* Desktop gets the big beautiful text back! Mobile hides it. */}
        {!isMobile && (
          <>
      ...
      {/* --- DESKTOP: 3 COLUMN MAJESTIC LAYOUT --- */}
      {!isMobile && (
        <>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginBottom: '60px' }}>
            <div className="alive-card" style={{ background: 'var(--bg-panel)', padding: '25px', borderRadius: '16px', border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column' }}>
            ...
            <div className="alive-card" style={{ background: 'var(--bg-panel)', padding: '25px', borderRadius: '16px', border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              {currentMedia ? (
